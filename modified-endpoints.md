...
Consent and authorisation have been **globalised in V2**. To keep this file focused on endpoint modifications only, the detailed comparison (endpoints, headers, request/response models) is documented separately here: **[consent & authorisation endpoints changes.md](https://github.com/TamJ38/Berlin-Group-NextGenPSD2-vs-Open-Finance-v2-Endpoint-Schema-Comparison/blob/dev/consent%20%26%20authorisation%20endpoints%20changes.md)**.
